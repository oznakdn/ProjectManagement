    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("95ac8e7f-2d1d-4361-996c-a297ba3a803c"), new DateTime(2022, 10, 19, 11, 4, 55, 179, DateTimeKind.Utc).AddTicks(4968), "IT", true, false });

            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "Id", "CreatedDate", "DepartmentName", "IsActive", "IsDeleted" },
                values: new object[] { new Guid("a2e896e8-ac0f-4b55-902e-38b8ec983c06"), new DateTime(2022, 10, 19, 11, 4, 55, 179, DateTimeKind.Utc).AddTicks(4970), "HR", true, false });

            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "Id", "CreatedDate", "IsActive", "IsDeleted", "ProjectDetails", "ProjectEndDate", "ProjectStartDate", "ProjectTitle" },
                values: new object[] { new Guid("11426e7f-ea32-4e01-90bf-7609d542a5c9"), new DateTime(2022, 10, 19, 11, 4, 55, 179, DateTimeKind.Utc).AddTicks(5253), true, false, "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.", new DateTime(2023, 1, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 1, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Crm software project" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("447e5a4d-9bae-48a4-a229-2b210068cea2"), new DateTime(2022, 10, 19, 11, 4, 55, 179, DateTimeKind.Utc).AddTicks(5091), new Guid("a2e896e8-ac0f-4b55-902e-38b8ec983c06"), new DateTime(1985, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Aslan", "Sevda", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQu5rOjQXpcVzkYiQ4bOlETYdskweUdNCK0mw&usqp=CAU", true, false });

            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "CreatedDate", "DepartmentId", "EmployeeBirthDate", "EmployeeLastname", "EmployeeName", "EmployeePicture", "IsActive", "IsDeleted" },
                values: new object[] { new Guid("f5a37fcc-ef2d-494c-8784-95bdb04195d9"), new DateTime(2022, 10, 19, 11, 4, 55, 179, DateTimeKind.Utc).AddTicks(5085), new Guid("95ac8e7f-2d1d-4361-996c-a297ba3a803c"), new DateTime(1980, 3, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kaplan", "Ali", "https://dm.henkel-dam.com/is/image/henkel/men_perfect_com_thumbnails_home_pack_400x400-wcms-international?scl=1&fmt=jpg", true, false });

            migrationBuilder.InsertData(
                table: "Contacts",
                columns: new[] { "Id", "Address", "City", "CreatedDate", "EmailAddress", "IsActive", "IsDeleted", "PhoneNumber" },
                values: new object[] { new Guid("f5a37fcc-ef2d-494c-8784-95bdb04195d9"), "Many desktop publishing packages and web page editors now use Lorem", "Samsun", new DateTime(2022, 10, 19, 11, 4, 55, 179, DateTimeKind.Utc).AddTicks(4778), "ali.kaplan@mail.com", true, false, "05999584578" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedDate", "EmployeeId", "IsActive", "IsDeleted", "Password", "Role", "Username" },
                values: new object[] { new Guid("0a69a0e7-e1c5-4554-b78d-50518dce0f49"), new DateTime(2022, 10, 19, 11, 4, 55, 179, DateTimeKind.Utc).AddTicks(5460), new Guid("447e5a4d-9bae-48a4-a229-2b210068cea2"), true, false, "aslnsvd123", 0, "sevda.aslan@mail.com" });
